        ...
        **kwargs,
        ...
        try:
            ...
            for epoch in range(epoch + 1, max_epochs + 1):
                ...
                if not train_with_dev and not anneal_against_dev_loss and bool(self.corpus.dev):
                ...
                if not train_with_dev and anneal_against_dev_loss and bool(self.corpus.dev):
